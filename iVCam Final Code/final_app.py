 ...
 # st.write(" angle is",angle)
  ...
  try:
    ...
    #st.write("rotation")
      ...
      language='en'
      final_image_new_text_detected_array = pytesseract.image_to_string(Image.open("2.jpg"))
      #st.write(final_image_new_text_detected_array)

      x="The dip of the image is not good. Please insert the proper image"
...
# audio=gTTS(text=instructions,lang=language,slow=False)
# audio.save("1.mp3")
# os.system("1.mp3")



if c1.button("Read Out Recipt Data"):
  language="en"
  audio=gTTS(text=final_image_new_text_detected_array,lang=language,slow=False)
  audio.save("1.wav")
  os.system("1.wav")
...
if c3.button("search"):
  ...
  language='en'
  audio=gTTS(text=w11,lang=language,slow=False)
  audio.save("1.wav")
  os.system("1.wav")
  

if c5.button("related"):
  recognized = takecommand()
  item = recognized
  item=item.lower()
  w11 = related(item)
...
# language="en"
# instructions = "Thank You For using the application"
# audio=gTTS(text=instructions,lang=language,slow=False)
# audio.save("1.mp3")
# os.system("1.mp3")
