...
img_before= cv2.imread('Final_Image_new.jpg')
try:
...
final_image_new_text_detected_array = str.split(final_image_new_text_detected)
#st.write(final_image_new_text_detected_array)
...
def final_result(item):
  ...
  #   w11=""
  #   for x in v.finditer(final_image_new_text_detected):
  #     st1=x.span()[0]
  #     en=x.span()[1]
